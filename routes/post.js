...
router.put("/posts/:post_id", [ auth_middleware([ ["post_modify"], ["admin"] ]), post_middleware.validateUpdatePost ], post_controller.updatePost);
...
router.put("/posts/:post_id/comments/:comment_index", [ auth_middleware([ ["comment_modify"], ["admin"] ]), post_middleware.validateUpdateComment ], post_controller.updateComment);

router.delete("/posts/:post_id/comments/:comment_index", [ auth_middleware([ ["comment_modify"], ["admin"] ]), post_middleware.validateDeleteComment ], post_controller.deleteComment);

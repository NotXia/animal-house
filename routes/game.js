...
router.get("/memory", auth_middleware(), game_controller.memoryInit(false));
router.get("/memory/guest", game_controller.memoryInit(true));
router.get("/memory/:game_id", game_middleware.validateMemoryAnswer, game_controller.memoryAttempt);

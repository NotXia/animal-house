...
import hubs_routes from "./pages/Hubs/routes.js"
import games_routes from "./pages/Games/routes.js"

let routes = [];
routes = routes.concat(home_routes);
routes = routes.concat(services_routes);
routes = routes.concat(hubs_routes);
routes = routes.concat(games_routes);

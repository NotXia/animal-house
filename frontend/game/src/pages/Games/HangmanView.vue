<script>
    ...
    export default {
        ...
        methods: {
            ...
            parseHangmanString(string) {
                let parts = [];

                for (let i=0; i<string.length; i++) {
                    switch (string[i]) {
                        case "+": parts.push("Vocale"); break;
                        case "-": parts.push("Consonante"); break;
                        case " ": parts.push("Spazio"); break;
                        default:  parts.push(string[i]); break;
                    }
                }
...
<template>
    ...
    <main style="height: 80vh">
        <div v-if="!game_id" class="d-flex align-items-center justify-content-center h-100">
            <section aria-label="Gioca all'impiccato">
        ...
        <div v-if="game_id" class="d-flex align-items-center justify-content-center h-100" aria-live="assertive">
            <div v-if="!game_end" class="container">
                <div class="row" style="min-height: 20vh; max-height: 40vh;">
                    <!-- Omino impiccato -->
                    <div class="col-12 col-md-6 text-center">
                        <section aria-label="Tentativi rimanenti">
                            <div style="height: 35vh; max-width: 35vh;" class="mx-auto my-auto" aria-hidden="true">
                            ...
                            <div class="visually-hidden" aria-live="assertive" aria-atomic="true">
                                {{ MAX_ATTEMPTS-failed_attempts === 1 ? "Rimane un tentativo" : `Rimangono ${MAX_ATTEMPTS-failed_attempts} tentativi` }}
                            </div>
                        </section>
                    </div>
                    ...
                    <div class="col-12 col-md-6 text-center">
                        <div class="d-flex align-items-center justify-content-center h-100">
                            <section aria-label="Parola corrente">
                                <p class="fs-1 m-0" aria-hidden="true">{{ word }}</p>
                                <p aria-live="assertive" aria-atomic="true" class="visually-hidden">Stato attuale: {{ parseHangmanString(word) }}</p>
                            </section>
                        </div>
                    </div>
                </div>
                ...
                <div class="row p-1 mt-3">
                    <section aria-label="Selettore lettere">
            ...
            <div v-if="game_end" class="text-center">
                <section aria-label="Resoconto partita">
                    <div v-if="points === 0" style="height: 20vh; max-width: 20vh;" class="mx-auto my-auto" aria-hidden="true">
                        <svg preserveAspectRatio="xMidYMid meet" viewBox="0 0 350 350" xmlns="http://www.w3.org/2000/svg">
                        <g>
                            <title>Layer 1</title>
                            <line stroke-width="5" stroke-linecap="undefined" stroke-linejoin="undefined" id="svg_1" y2="344.73982" x2="288.52019" y1="344.73982" x1="7.65234" stroke="#000" fill="none"/>

                ...
                <div class="col-7 col-lg-5 offset-lg-1">
                    <div class="d-flex justify-content-center">
                        <div class="w-50">
                            ...
                            <input type="time" class="form-control" name="working_time-${day_of_week}-${index}-time-start" id="data-${day_of_week}-${index}-time-start" value="${start_time ? moment.utc(start_time).format("HH:mm") : ""}">
                        </div>
                        <div class="w-50">
                            <label for="data-${day_of_week}-${index}-time-end">Fine</label>
                            <input type="time" class="form-control" name="working_time-${day_of_week}-${index}-time-end" id="data-${day_of_week}-${index}-time-end" value="${end_time ? moment.utc(end_time).format("HH:mm") : ""}">
                        </div>
                    </div>
                </div>

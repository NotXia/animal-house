...
export function render(service, index) {
    ...
    let onlineIcon = service.online ? `<img src="/img/icons/check.png" alt="Servizio ${escaped_name} online" class="service-online" />` : `<img src="/img/icons/cross.png" alt="Servizio ${escaped_name} in presenza" class="service-online" />`;
